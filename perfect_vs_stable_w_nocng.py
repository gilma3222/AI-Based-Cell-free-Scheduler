...
if __name__ == "__main__":
    ...
    Perfect_match, = plt.plot(graf_perfect[0], graf_perfect[1], 'r', label='Perfect match')
    ...
    Perfect_match, = plt.plot(graf_perfect[0], graf_perfect[2], 'r', label='Perfect match')
    ...
    Perfect_match, = plt.plot(graf_perfect[0], graf_perfect[3], 'r', label='Perfect match')
