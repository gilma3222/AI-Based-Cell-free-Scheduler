...
if __name__ == "__main__":
    ...
    for drop in range(9):
        ...
        for run in range(2000):
            ...
            for i in range(2 * nf):
                for j in range(2 * nf):
                    if np.mod(i, 2) == 0:
                        w[i][j] = state[0][choosen[j][0] * 2] - state[0][choosen[j][0] * 2 + 1]  ## an option is to sub the largest rssi among the rest
                    else:
    ...
    random_scheduler, = plt.plot(graf_rand[0], graf_rand[1], 'g', label='Round robin')
    ...
    plt.legend()
    plt.grid()
    plt.savefig('/home/gilmam/Desktop/study/scheduler/throughput.png')
    ...
    random_scheduler, = plt.plot(graf_rand[0], graf_rand[2], 'g', label='Round robin')
    ...
    plt.legend()
    plt.grid()
    plt.savefig('/home/gilmam/Desktop/study/scheduler/packet_loss.png')
    plt.figure(3)
    ...
    random_scheduler, = plt.plot(graf_rand[0], graf_rand[3], 'g', label='Round robin')
    ...
    plt.legend()
    plt.grid()
    plt.savefig('/home/gilmam/Desktop/study/scheduler/power.png')
    plt.show
