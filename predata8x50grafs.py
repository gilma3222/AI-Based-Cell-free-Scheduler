...
if __name__ == "__main__":
    ...
    class Net(nn.Module):
        ...
        def forward(self, xa):
            ...
            #     x = self.softmax2(x)
            x = self.softmax1(x.view(-1, 16, 16))
            # x = self.softmax2(x)
            x = self.lsm(x)
    ...
    model = Net()
    model123 = torch.load('/home/gilmam/Desktop/study/scheduler/data8x50/gil/model5mt1')#/home/gilmam/Desktop/study/scheduler/data8x50/gil
    ...
    #     graf_perfect[1][drop] = (totalpass / 10000)
    #     print('packet loss: ', (totalloss / 10000))
    #     graf_perfect[2][drop] = totalloss / 10000
    #     print("average power: ", (totalpower / 10000))
    #     graf_perfect[3][drop] = (totalpower / 10000)
    #
 ...
 #
   ...
   # random_scheduler, = plt.plot(graf_rand[0], graf_rand[1], 'g', label='Random')
    ...
    plt.legend()
    plt.grid()
    plt.savefig('/home/gilmam/Desktop/study/scheduler/data8x50/gil/throughput_8x2NN10k_randspan.png')
    plt.figure(2)
    ...
    plt.legend()
    plt.grid()
    plt.savefig('/home/gilmam/Desktop/study/scheduler/data8x50/gil/packet_loss_8x2NN10k_randspan.png')
    plt.figure(3)
    ...
    plt.legend()
    plt.grid()
    plt.savefig('/home/gilmam/Desktop/study/scheduler/data8x50/gil/power_8x2NN10k_randspan.png')
    plt.show
