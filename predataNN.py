...
if __name__ == "__main__":
    ...
    #         # x12112 = np.load('testdatastate.npy')
    #         # y1212 = x12112.tolist()
    # else:
    #     drop = 6
    #
    ...
    #         choosen = sortedbuffer[0:4]
    #         datastate.append(state)
    #         tempbuf = choosen.copy()
    #         databuffer.append(tempbuf)
    #         ####################     Exhaustive search    ######################
    #
    #         max_reward = 0
    #         for i1 in range(4):
    ...
    #                             powerop = np.array([[0., 0.], [0., 0.]])
    #                             aop = np.array([[choosen[i1][0], choosen[i2][0]], [choosen[i3][0], choosen[i4][0]]])
    #                             aopp = np.array([[1, 1], [1, 1]])
    #                             A_1 = state[0][choosen[i1][0] * 2] - state[0][choosen[i1][0] * 2 + 1] + state[0][
    #                                 choosen[i2][0] * 2 + 1] - state[0][choosen[i2][0] * 2]
    #                             A_2 = state[0][choosen[i3][0] * 2] - state[0][choosen[i3][0] * 2 + 1] + state[0][
    #                                 choosen[i4][0] * 2 + 1] - state[0][choosen[i4][0] * 2]
    #                             if A_1 < 8:
    #                                 # if choosen[i1][1] < choosen[i2][1]:
    #                                     aopp[0][1] = 0
    #                                     powerop[0][0] = 4 - (state[0][choosen[i1][0] * 2] - state[0][choosen[i1][0] * 2 + 1])
    #                                 # else:
    #                                 #     aopp[0][0] = 0
    #                                 #     powerop[0][1] = 4 - (state[0][choosen[i2][0] * 2 + 1] - state[0][choosen[i2][0] * 2])
    #                             else:
    #                                 if state[0][choosen[i1][0] * 2] - state[0][choosen[i1][0] * 2 + 1] < 4:
    #                                     powerop[0][0] = -(state[0][choosen[i1][0] * 2] - state[0][
    #                                         choosen[i1][0] * 2 + 1] - 4)
    #                                 if state[0][choosen[i2][0] * 2 + 1] - state[0][choosen[i2][0] * 2] < 4:
    #                                     powerop[0][1] = -(state[0][choosen[i2][0] * 2 + 1] - state[0][
    #                                         choosen[i2][0] * 2] - 4)
    #
    #                             if A_2 < 8:
    #                                 # if choosen[i3][1] < choosen[i4][1]:
    #                                     aopp[1][1] = 0
    #                                     powerop[1][0] = 4 - (state[0][choosen[i3][0] * 2] - state[0][choosen[i3][0] * 2 + 1])
    #                                 # else:
    #                                 #     aopp[1][0] = 0
    #                                 #     powerop[1][1] = 4 - (state[0][choosen[i4][0] * 2 + 1] - state[0][choosen[i4][0] * 2])
    #                             else:
    #                                 if state[0][choosen[i3][0] * 2] - state[0][choosen[i3][0] * 2 + 1] < 4:
    #                                     powerop[1][0] = -(state[0][choosen[i3][0] * 2] - state[0][
    #                                         choosen[i3][0] * 2 + 1] - 4)
    #                                 if state[0][choosen[i4][0] * 2 + 1] - state[0][choosen[i4][0] * 2] < 4:
    #                                     powerop[1][1] = -(state[0][choosen[i4][0] * 2 + 1] - state[0][
    #                                         choosen[i4][0] * 2] - 4)
    #                             reward = 50 * (1 * (aopp[0][0] > 0) + 1 * (aop[0][1] > 0) + 1 * (
    #                                         aop[1][0] > 0) + 1 * (aop[1][1] > 0)) - (
    #                                                  powerop[0][0] + powerop[0][1] + powerop[1][0] + powerop[1][1])
    #                             if reward > max_reward:
    #                                 max_reward = reward
    #                                 action = aop
    #                                 pAction = powerop
    ...
    #         # if action[0][0] == -1:
    #         #     for kkk in sortedbuffer[4:]:
    #         #         if state[0][kkk[0] * 2] - state[0][kkk[0] * 2 + 1] + state[0][action[0][1] * 2 + 1] - state[0][
    #         #             action[0][1] * 2] > 8:
    #         #             action[0][0] = kkk[0]
    #         #             if state[0][action[0][0] * 2] - state[0][action[0][0] * 2 + 1] < 4:
    #         #                 pAction[0][0] = -(state[0][action[0][0] * 2] - state[0][action[0][0] * 2 + 1] - 4)
    ...
    #         # if action[0][1] == -1:
    #         #     for kkk in sortedbuffer[4:]:
    #         #         if state[0][kkk[0] * 2 + 1] - state[0][kkk[0] * 2] + state[0][action[0][0] * 2] - state[0][
    #         #             action[0][0] * 2 + 1] > 8:
    #         #             action[0][1] = kkk[0]
    #         #             if state[0][action[0][1] * 2 + 1] - state[0][action[0][1] * 2] < 4:
    #         #                 pAction[0][1] = -(state[0][action[0][1] * 2 + 1] - state[0][action[0][1] * 2] - 4)
    ...
    #         # if action[1][0] == -1:
    #         #     for kkk in sortedbuffer[4:]:
    #         #         if state[0][kkk[0] * 2] - state[0][kkk[0] * 2 + 1] + state[0][action[1][1] * 2 + 1] - state[0][
    #         #             action[1][1] * 2] > 8:
    #         #             action[1][0] = kkk[0]
    #         #             if state[0][action[1][0] * 2] - state[0][action[1][0] * 2 + 1] < 4:
    #         #                 pAction[1][0] = -(state[0][action[1][0] * 2] - state[0][action[1][0] * 2 + 1] - 4)
    ...
    #         # if action[1][1] == -1:
    #         #     for kkk in sortedbuffer[4:]:
    #         #         if state[0][kkk[0] * 2 + 1] - state[0][kkk[0] * 2] + state[0][action[1][0] * 2] - state[0][
    #         #             action[1][0] * 2 + 1] > 8:
    #         #             action[1][1] = kkk[0]
    #         #             if state[0][action[1][0] * 2] - state[0][action[1][0] * 2 + 1] < 4:
    #         #                 pAction[1][0] = -(state[0][action[1][0] * 2] - state[0][action[1][0] * 2 + 1] - 4)
    ...
    #     graf[1][drop] = totalpass / runs
    #     print('packet loss: ', (totalloss / runs))
    #     graf[2][drop] = totalloss / runs
    #     print("average power: ", (totalpower / runs))
    #     graf[3][drop] = totalpower / runs
        # x12112 = np.load('testdatastate.npy')
        # y1212 = x12112.tolist()



    # np.save('testdatastate.npy', datastate)
    # np.save('testdatabuffer.npy', databuffer)
    ...
    print('average TTL: ', (13 - drop))
    print('throughput: ' + str(totalpass / 200000))
    graf_perfect[1][drop] = (totalpass / 20000)
    print('packet loss: ', (totalloss / 200000))
    graf_perfect[2][drop] = totalloss / 200000
    print("average power: ", (totalpower / 200000))
    graf_perfect[3][drop] = (totalpower / 200000)
