...
if __name__ == "__main__":
    ...
    #
        ...
        graf_perfect[1][drop] = (totalpass / runs)
        print('packet loss: ', (totalloss / runs))
        graf_perfect[2][drop] = totalloss / runs
        print("average power: ", (totalpower / runs))
        graf_perfect[3][drop] = (totalpower / runs)
    np.save('graf_newst', graf_perfect)
    ####################################################################################
    ...
    #     graf_perfect_det[1][drop] = (totalpass / 10000)
    #     print('packet loss: ', (totalloss / 10000))
    #     graf_perfect_det[2][drop] = totalloss / 10000
    #     print("average power: ", (totalpower / 10000))
    #     graf_perfect_det[3][drop] = (totalpower / 10000)
    ...
    Perfect_match_NN_10f, = plt.plot(graf_perfect[0], graf_perfect[1], 'c', label='Perfect match NN 250F')
    ...
    plt.legend()
    plt.grid()
    plt.savefig('/home/gilmam/Desktop/study/scheduler/data8x50/gil/throughput_8x2NN1k_250f.png')
    plt.figure(2)
    Perfect_match_NN_10f, = plt.plot(graf_perfect[0], graf_perfect[2], 'c', label='Perfect match NN 250F')
    ...
    plt.legend()
    plt.grid()
    plt.savefig('/home/gilmam/Desktop/study/scheduler/data8x50/gil/packet_loss_8x2NN1k_250f.png')
    plt.figure(3)
    Perfect_match_NN_10f, = plt.plot(graf_perfect[0], graf_perfect[3], 'c', label='Perfect match NN 250F')
    ...
    plt.legend()
    plt.grid()
    plt.savefig('/home/gilmam/Desktop/study/scheduler/data8x50/gil/power_8x2NN1k_250f.png')
    plt.show
    gil = 10